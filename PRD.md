...
| FR-11 | Menu utama menampilkan fitur ke-4 `Dino Merdeka`; setelah aset siap Dino menunggu tap dan countdown overlay `Bersedia - Siap - Mulai`, lalu permainan mendukung sentuh/klik/Space, parallax bandara, obstacle darat/pesawat rendah, collision, peningkatan kecepatan, pause, dan game over. | P0 |
